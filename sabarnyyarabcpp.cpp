...
//	while (input >> gameplayer.high_score) {
...
//				else {
//
//					max_two_22 = gameplayer.high_score;
//					checkkkkk = false;
//
//				}
//		
...
//				{
//					if (ball.shooting_ball[counter].getTexture() == &redd && upper_ball_colors[0][i].getTexture()
//						== &redd)
//					{
//						for (int r = 0; r < 10; r++)
//						{
...
//				{
//					if (ball.shooting_ball[counter].getTexture() == &redd && upper_ball_colors[4][i].getTexture()
//						== &redd)
//					{
//						for (int r = 4; r < 8; r++)
//						{
...
//		max2.setFont(font);
//		max2.setPosition(400, 400);
//		max2.setFillColor(Color::White);
//		max2.setString("HighScore::" + to_string(max_two_22));
//
//
//
//		window.clear();
...
//					if (col > 16)
//					{
//						if (upper_ball_colors[row][col].getScale().x > 0 && upper_ball_colors[row][col].getScale().y
//						> 0)
//						{
//							window.draw(upper_ball_colors[row][col]);
//						}
...
//			if (checkkkkk==true)
//			{
//				window.draw(score_max);
//
//			}
//			else if (checkkkkk == false)
//			{
//				window.draw(max2);
//			}
//
